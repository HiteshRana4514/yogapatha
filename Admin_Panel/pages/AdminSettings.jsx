        ...
        <div className="bg-white rounded-xl p-6 shadow-sm border border-gray-100">
          ...
          <form onSubmit={handlePasswordReset} className="space-y-4">
            <div>
              ...
              <div className="relative">
                ...
                <button
                  ...
                  className="absolute right-4 top-1/2 transform -translate-y-1/2 text-[#336b6e] opacity-50 hover:opacity-100 transition-opacity"
                >
            ...
            <button
              type="submit"
              disabled={isLoading}
              className="w-full bg-gradient-to-r from-[#336b6e] to-[#2a5557] text-[#bb9f58] py-3 px-6 rounded-xl font-semibold hover:shadow-lg transform hover:scale-105 transition-all duration-300 disabled:opacity-50 disabled:cursor-not-allowed disabled:transform-none flex items-center justify-center gap-2"
            >
              {isLoading ? (
                <>
                  <Loader2 className="w-5 h-5 animate-spin" />
