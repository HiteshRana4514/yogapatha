...
function TrainerCodeOfConduct() {
    ...
    return (
        <>
            <SEO
                title="Trainer Code of Conduct | YogaPatha"
                description="Professional and ethical standards expected of all trainers operating on the YogaPatha platform to ensure client safety and service quality."
                keywords="trainer code of conduct, professional standards, yoga trainer ethical guidelines"
            />
