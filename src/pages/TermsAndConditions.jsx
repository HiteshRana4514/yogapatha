...
function TermsAndConditions() {
    ...
    return (
        <>
            <SEO
                title="Terms & Conditions | YogaPatha"
                description="Review the terms and conditions for using the YogaPatha platform. Understand your rights and responsibilities as a user."
                keywords="terms and conditions, legal agreement, YogaPatha terms"
            />
