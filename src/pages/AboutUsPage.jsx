...
function AboutUsPage() {
  ...
  return (
    <>
      <SEO
        title="About YogaPatha | Connecting You with Certified Yoga Trainers"
        description="YogaPatha is India's leading platform connecting you with certified yoga trainers for your specific wellness needs. Learn about our mission and expert trainers."
        keywords="about yoga patha, certified yoga trainers India, yoga mission, best yoga platform India, hire yoga instructor online"
        canonicalUrl="https://www.yogapatha.in/about_us"
      />
