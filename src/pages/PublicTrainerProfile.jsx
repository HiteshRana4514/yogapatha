...
const PublicTrainerProfile = () => {
  ...
  const handleWhatsApp = () => {
    const phoneNumber = '919876543210'; // Replace with business WhatsApp
            ...
            <div className="bg-gradient-to-br from-[#336b6e] to-[#1e4040] rounded-2xl shadow-xl p-6 text-white relative overflow-hidden">
              ...
              <div className="relative z-10">
                ...
                <div className="space-y-3">
                  ...
                  <button
                    onClick={handleWhatsApp}
                    className="w-full flex items-center justify-center gap-2 px-5 py-3 bg-white/10 hover:bg-white/20 border border-white/20 text-white font-semibold rounded-xl transition-all duration-300 hover:scale-105"
                  >
