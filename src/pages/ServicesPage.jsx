...
function ServicesPage() {
  ...
  return (
    <>
      <SEO
        title="Professional Yoga Services | Home & Online Yoga Classes"
        description="Book certified yoga trainers for home sessions and online classes across India. Specialized sessions for weight loss, meditation, prenatal, and therapy yoga."
        keywords="online yoga classes, personal yoga trainer, yoga trainers near me, home yoga sessions, yoga for weight loss, meditation yoga classes, prenatal yoga trainer, therapy yoga sessions"
        canonicalUrl="https://www.yogapatha.in/services"
      />
